...
@Entity
@Table(name = "PROMEDIOSMENSUALES", catalog = "", schema = "SIDISAT")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PromediosMensuales.findAll", query = "SELECT e FROM PromediosMensuales e"),
    @NamedQuery(name = "PromediosMensuales.findMax", query = "SELECT MAX(e.idPromedioMensuales) FROM PromediosMensuales e")})
public class PromediosMensuales implements Serializable {
    ...
    @NotNull
    @Column(name = "IDPROMEDIOMENSUALES")
    private BigDecimal idPromedioMensuales;
    @Size(max = 20)
    ...
    @Column(name = "PERIODOREFERENCIA")
    private String periodoReferencia;
    @Column(name = "NANIOSCOMPLETOS")
    private Double nAnioCompletos;
    @Size(max = 150)
    @Column(name = "OBSERVACIONES")
    private String observaciones;

    public PromediosMensuales() {
    }
    ...
    public BigDecimal getIdPromedioMensuales() {
        return idPromedioMensuales;
    }

    public void setIdPromedioMensuales(BigDecimal idPromedioMensuales) {
        this.idPromedioMensuales = idPromedioMensuales;
    }
    ...
    public Double getnAnioCompletos() {
        return nAnioCompletos;
    }

    public void setnAnioCompletos(Double nAnioCompletos) {
        this.nAnioCompletos = nAnioCompletos;
    }
